...
var numFirst = +prompt("Введіть початкове число");
var numLast = +prompt("Введіть кінцеве число");
var sumAll = 0;
...
;
console.log(sumAll); // Норма
// Запитай у користувача п’ятирозрядне число і визначи, чи є воно паліндромом.

var num1 = 12321; //+prompt("Введіть п’ятирозрядне число");
...
var sumBy = 270; //+prompt("Введіть число");
...
for (var i = 0; i < 10; i++) {
  var numAsk = +prompt("Введіть число");
...
console.log("Не парних чисел - " + odd); // Зацикли відображення днів тижня таким чином: «День тижня. Хочеш побачити наступний день? » і так до тих пір,
...
var first = 0;
var last = 100;
var yourNum = Math.round((last - first) / 2);

do {
  var quest = prompt("Ваше число більше (>), меньше (<) чи дорівнює (=) " + yourNum + "?");
...
var yourNumber = "Ваше число: " + yourNum;
console.log(yourNumber); // Виведи таблицю множення для всіх чисел від 2 до 9. Кожне число необхідно помножити на числа від 1 до 10.
...
do {
  for (var _a = 0; _a < 10; _a++) {
    var result = startNum * finNum;
    console.log("".concat(startNum, " * ").concat(finNum, " = ").concat(result));
    finNum++;
  }
