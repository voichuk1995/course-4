...
const drib = {
    create: function (nom, denom) {
        if (isInteger(nom) && isInteger(denom)) {
            const a = {
                numerator: nom,
                denominator: denom,
            }
    ...
    add: function (dribFirst, dribSecond) {
        const a = {
            numerator: dribFirst.numerator * dribSecond.denominator + dribSecond.numerator * dribFirst.denominator,
...
const f = drib.create(+prompt("Введіть чисельник першого дробу", "3"), +prompt("Введіть знаменник першого дробу", "5"));
const g = drib.create(+prompt("Введіть чисельник другого дробу", "4"), +prompt("Введіть другого першого дробу", "10"));
