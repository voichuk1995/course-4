...
console.log("Сума:");
drib.display(h);
console.log("Спрощена сума:");
drib.display(drib.simplify(h));


const k = drib.subtract(f, g);
console.log("Різниця:");
drib.display(k);
console.log("Спрощена різниця:");
drib.display(drib.simplify(k));


const l = drib.multiply(f, g);
console.log("Добуток:");
drib.display(l);
console.log("Спрощений добуток")
drib.display(drib.simplify(l));
...
console.log("Частка:");
drib.display(m);
console.log("Спрощена частка:");
drib.display(drib.simplify(m));
