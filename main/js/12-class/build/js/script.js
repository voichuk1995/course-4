...
function buildTemplate(template, options) {
  ...
  var templateDOM = div.firstChild;
...
var CustomWindow = /*#__PURE__*/function () {
  function CustomWindow(options) {
    ...
    _classPrivateFieldSet(this, _template, "<div class=\"modal\">\n        <div class=\"modal__window\">\n            <div class=\"modal__content\">\n                \n            </div>\n            <div class=\"modal__footer\">\n                <button class=\"modal__close close\"><span>Close</span></button>\n            </div>\n        </div>\n    </div>");

    this.modal = buildTemplate(_classPrivateFieldGet(this, _template), this.options);
    this.addModal();
    addEvent(this);
  }
  ...
  _createClass(CustomWindow, [{
    ...
    value: function open() {
      ...
      console.log(this);
      (_this$modal = this.modal) === null || _this$modal === void 0 ? void 0 : _this$modal.classList.add(this.options.openClassName);
    }
  }, {
    key: "close",
    value: function close() {
      ...
      (_this$modal2 = this.modal) === null || _this$modal2 === void 0 ? void 0 : _this$modal2.classList.remove(this.options.openClassName);
    }
  }, {
    key: "contentClass",
    get: function get() {
    ...
    set: function set(data) {
      ...
      (_this$modal3 = this.modal) === null || _this$modal3 === void 0 ? void 0 : _this$modal3.classList.replace(this.options.contentClass, data);
...
var OtheWindow = /*#__PURE__*/function (_CustomWindow) {
  _inherits(OtheWindow, _CustomWindow);

  var _super = _createSuper(OtheWindow);

  function OtheWindow(options) {
    var _this;

    _classCallCheck(this, OtheWindow);
  ...
  _createClass(OtheWindow, [{
    key: "open",
    value: function open() {
      var _this$modal4;

      console.log('custom window');
      (_this$modal4 = this.modal) === null || _this$modal4 === void 0 ? void 0 : _this$modal4.classList.add(this.options.openClassName);
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _customWindow__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customWindow */ "./src/js/customWindow.js");

var CustomWindow = _customWindow__WEBPACK_IMPORTED_MODULE_0__["default"].CustomWindow;
var OtheWindow = _customWindow__WEBPACK_IMPORTED_MODULE_0__["default"].OtheWindow;
var s = new OtheWindow({
  content: '2222'
});
var myAlert = new CustomWindow({
  selector: '.modal',
  content: 'sdfsdfds'
});
console.log(s.open(), myAlert);
var myAlert2 = new CustomWindow({
  selector: '.modal',
  content: '11111111'
});
myAlert.contentClass = '111';
var b = document.querySelector('.open-alert');
b.addEventListener('click', myAlert.open.bind(myAlert));
var c = document.querySelector('.open-alert1');
...
/******/ 	__webpack_require__("./src/js/customWindow.js");
