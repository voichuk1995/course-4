...
//number
const num = (2, 1.5, -1, 0, -0, Infinity, -Infinity, NaN);
console.log(NaN === NaN)
console.log(+'2323')
console.log(2 + +'2323')
console.log(isNaN(NaN), isNaN('dasfasdf'), NaN !== NaN, Number.isNaN('asdfds'));
console.log(Number.MAX_SAFE_INTEGER);
console.log((2.32445415).toFixed(2) + "$")
...
const string = ("ss " + " sdg 2\" 'dhjs' dkj;", 's \' "dgf" s', `s dfg
...
const typeSymbol = Symbol('ddd');
const fff = Symbol('ddd');

console.log(typeSymbol, fff);

//Об’єктні типи, що змінюються
const arr = [1, 3, 1, 1, 1, true, {}, []];
